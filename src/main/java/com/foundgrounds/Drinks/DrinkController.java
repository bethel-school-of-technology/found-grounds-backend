...
import com.backendfinal.drinks.DrinkRepository;
...
public class DrinkController {
	...
	public List<Drink> getDrink() {
		...
		public ResponseEntity<Drink> postDrink(@RequestBody Post drinks) {
		...
		public ResponseEntity<Drink> putDrink(@PathVariable Integer id, @RequestBody Post drinks) {
			Drink foundDrink = dao.findById(id).orElse(null);
			if (foundDrink == null) {
				return ResponseEntity.notFound().header("Message", "Nothing found with that id").build();
			} else {
